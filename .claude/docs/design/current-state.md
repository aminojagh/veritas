...
it. Nothing is measured yet. A question that says an Ambiguous Term in any spelling
[Glossary Section D](../glossary.md#d-ambiguous-terms) registers is now detected as
...
- **Next: Sub-step 7.3 — measure Retrieval: hit rate and Mean Reciprocal Rank (MRR).**
  ...
  *Also said as* column, `aliases` on every Ambiguous Term, and detection over every
  ...
  Still to come: hit rate and MRR with the two measured arms
...
- **Nothing awaits Amino.** Section D's *Also said as* column — nine spellings, and the
  ruling inside them that *"turnover"* is a spelling of the Ambiguous Term `volume`
  rather than an alias of `Traded Notional` — was agreed on 2026-09-01 with Sub-step
  7.2. No Term Proposal is open either: 7.1's two were agreed the same day and are
...
- **The handoff detail for Sub-step 7.2 is in its
  [review entry](../reviews/step-007-evaluation.md#sub-step-72--register-the-phrasings-and-detect-them)**,
  and 7.1's in
...
question find its metric; the Gold Question Set is what will, in Sub-step 7.3. An
...
**Open debt: 15 · open extensions: 11.** 7.1 paid three on one Trigger — the Gold
Question Set —
[DEBT-033](../debt-ledger.md#debt-033--the-generators-live-evidence-is-five-self-written-questions-and-four-certified-metrics-never-reach-it)
