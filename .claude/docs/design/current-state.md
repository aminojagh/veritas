...
not only in the registered name. Step 008 — Observability — is `active`, and its first
two Sub-steps are built: the OpenAI default model is `gpt-5.4-mini`, chosen by measuring
four candidates, and it answers every answerable Gold Question correctly; and a Grounded
Answer's Lineage names what the statement used rather than what the model was shown.**
...
- **Sub-step 8.2 is built and awaits Amino's ruling, and 8.1 is committed (`2cf4170`).
  Next is Sub-step 8.3 — record every question a person asks.** 8.2 paid
  [DEBT-034](../debt-ledger.md#debt-034--lineage-records-what-the-model-was-shown-not-what-the-statement-used):
  ...
  **failed its own runner** — Groq's free tier is capped at 200,000 tokens per day, the
  ...
  the second with a question in it for Amino.
  [Step 008 — Observability](../plan/step-008-observability.md) is `active`, approved
  on 2026-09-03, five Sub-steps: 8.1 and 8.2, both built and described above;
...
- **No Term Proposal is open**: the plan's two —
  ...
  **`Gold Question`** and **`Relevant Set`** were agreed on 2026-09-01, and 7.2's
  Section D column the same day. **The debt picture after 8.2:**
  [DEBT-034](../debt-ledger.md#debt-034--lineage-records-what-the-model-was-shown-not-what-the-statement-used)
  is **paid**, on its own Trigger, by 8.2.
  [DEBT-035](../debt-ledger.md#debt-035--a-composed-certified-metric-has-no-statement-the-gate-allows)
  ...
  documentation pass needs it. 8.2 opened none. `DEFAULT_PROMPT_FORM` stays `rules`, now on a margin
